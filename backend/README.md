...
## Project Structure
    ...
    ├── testapiautoconnecto_86187  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_86187`
...
2. Clone this repo and `cd testapiautoconnecto_86187`
